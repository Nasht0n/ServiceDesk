$("body").on("click", "#btnAddReplaceEquipments", function (val) {
    ...
    cell.attr("class", "w-100");
    var innerInventoryNumber = '<input type="text" class="form-control tblItem bg-white border-0" readonly name="Model.Installations[' + counter + '].InventoryNumber" value="' + inventoryNumber.val() + '"/>';
