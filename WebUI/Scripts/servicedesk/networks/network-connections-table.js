$("body").on("click", "#btnAddConnection", function (val) {
    ...
    var count = $("#Count");
    var tBody = $("#tblConnections > TBODY")[0];
    var row = tBody.insertRow(-1);
    var cell = $(row.insertCell(-1));
    var innerEquipmentTypeId = '<input type ="hidden" class="readonly" name = "Model.Connections[' + counter + '].EquipmentTypeId" value = "' + selectedValue + '" />';
    cell.attr("class", "d-none");
    cell.html(innerEquipmentTypeId);
    var cell = $(row.insertCell(-1));
    var innerEquipmentTypeModelId = '< input type = "hidden" class="readonly" name = "Model.Connections[' + counter + '].EquipmentTypeModel.Id" value = "' + selectedValue + '" /> ';
    cell.attr("class", "d-none");
