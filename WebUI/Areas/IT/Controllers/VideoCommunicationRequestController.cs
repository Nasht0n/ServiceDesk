...
{
    public class VideoCommunicationRequestController : Controller
    {
        private const int SERVICE_ID = 17;
        ...
        private readonly IVideoCommunicationRequestLogic requestLogic;
        private readonly IVideoCommunicationRequestLifeCycleLogic lifeCycleLogic;
        private readonly IEquipmentLogic equipmentLogic;

        public VideoCommunicationRequestController(IAccountLogic accountLogic, IEmployeeLogic employeeLogic, IAccountPermissionLogic accountPermissionLogic,
           ...
           IVideoCommunicationRequestLogic requestLogic, IVideoCommunicationRequestLifeCycleLogic lifeCycleLogic, IEquipmentLogic equipmentLogic)
        {
        ...
        {
            VideoCommunicationRequest request = new VideoCommunicationRequest();
        ...
        private VideoCommunicationRequestLifeCycle InitializeLifeCycle(int requestId, Employee user, string message)
        {
            VideoCommunicationRequestLifeCycle lifeCycle = new VideoCommunicationRequestLifeCycle();
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            VideoCommunicationRequest request = await requestLogic.GetRequestById(id);
            List<VideoCommunicationRequestLifeCycle> lifeCycles = await lifeCycleLogic.GetLifeCycles(request);
            VideoCommunicationDetailsRequestViewModel model = ModelFromData.GetViewModel(request, user, lifeCycles);
            return View(model);
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Create(VideoCommunicationRequestViewModel model)
        {
            await PopulateDropDownList(model);
            Employee user = await PopulateAccountInfo();
        ...
        public async Task<ActionResult> Edit(int id)
        {
            await PopulateAccountInfo();
            var request = await requestLogic.GetRequestById(id);
            VideoCommunicationRequestViewModel model = ModelFromData.GetViewModel(request);
            await PopulateDropDownList(model);
            return View(model);
        }
        [HttpPost]
        public async Task<ActionResult> Edit(VideoCommunicationRequestViewModel model)
        {
            Employee user = await PopulateAccountInfo();
            await PopulateDropDownList(model);
