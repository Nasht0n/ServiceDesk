...
namespace WebUI.Areas.IT.Controllers
{
    ...
    public class VideoCommunicationRequestController : Controller
    {
        ...
        public VideoCommunicationRequestController(IAccountLogic accountLogic, IEmployeeLogic employeeLogic, IAccountPermissionLogic accountPermissionLogic,
           ...
           IVideoCommunicationRequestLogic requestLogic, IVideoCommunicationRequestLifeCycleLogic lifeCycleLogic)
        {
        ...
        private bool IsApproval(Service service, List<VideoCommunicationRequestLifeCycle> lifeCycles)
        {
            // флаг согласования
