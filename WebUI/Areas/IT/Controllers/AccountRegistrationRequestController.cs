...
namespace WebUI.Areas.IT.Controllers
{
    ...
    public class AccountRegistrationRequestController : Controller
    {
        ...
        public AccountRegistrationRequestController(IAccountLogic accountLogic, IEmployeeLogic employeeLogic, IAccountPermissionLogic accountPermissionLogic,
            ...
            IAccountRegistrationRequestLifeCycleLogic lifeCycleLogic, IBranchLogic branchLogic, ICategoryLogic categoryLogic, IRequestsLogic requestsLogic,
        ...
        /// <summary>
        /// Метод инициализации выпадающего списка приоритета заявки
        /// </summary>
        ...
        /// </summary>
        /// <param name="model">Модель заявки на аннулирование учетной записи</param>
