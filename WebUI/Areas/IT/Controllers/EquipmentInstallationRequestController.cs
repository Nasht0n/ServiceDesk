...
namespace WebUI.Areas.IT.Controllers
{
    public class EquipmentInstallationRequestController : Controller
    {
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            EquipmentInstallationRequest request = await requestLogic.GetRequest(id);
            var service = await serviceLogic.GetService(request.ServiceId);
            List<EquipmentInstallationRequestLifeCycle> lifeCycles = await lifeCycleLogic.GetLifeCycles(request);
