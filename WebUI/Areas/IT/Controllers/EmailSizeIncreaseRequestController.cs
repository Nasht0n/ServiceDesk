...
namespace WebUI.Areas.IT.Controllers
{
    ...
    public class EmailSizeIncreaseRequestController : Controller
    {
        ...
        public EmailSizeIncreaseRequestController(IAccountLogic accountLogic, IEmployeeLogic employeeLogic, IAccountPermissionLogic accountPermissionLogic,
           IPriorityLogic priorityLogic, IServiceLogic serviceLogic, ISubdivisionLogic subdivisionLogic,
           IBranchLogic branchLogic, ICategoryLogic categoryLogic, IRequestsLogic requestsLogic,
           IEmailSizeIncreaseRequestLogic requestLogic, IEmailSizeIncreaseRequestLifeCycleLogic lifeCycleLogic)
        {
        ...
        private bool IsApproval(Service service, List<EmailSizeIncreaseRequestLifeCycle> lifeCycles)
        {
            // флаг согласования
        ...
        /// <param name="id">Идентификатор заявки</param>
        /// <returns></returns>
        public async Task<ActionResult> AddMessage(int id, EmailSizeIncreaseDetailsRequestViewModel model)
        {
            // получение данных об авторизованном сотруднике
            // инициализация конфигурации
            var user = await PopulateAccountInfo();
