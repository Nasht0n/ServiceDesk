...
namespace WebUI.Areas.IT.Controllers
{
    ...
    public class HoldingPhoneLineRequestController : Controller
    {
        ...
        public HoldingPhoneLineRequestController(IAccountLogic accountLogic, IEmployeeLogic employeeLogic, IAccountPermissionLogic accountPermissionLogic,
           ...
           IHoldingPhoneLineRequestLogic requestLogic, IHoldingPhoneLineRequestLifeCycleLogic lifeCycleLogic)
        {
        ...
        private bool IsApproval(Service service, List<HoldingPhoneLineRequestLifeCycle> lifeCycles)
        {
            // флаг согласования
