...
{
    public class HoldingPhoneLineRequestController : Controller
    {
        private const int SERVICE_ID = 13;
        ...
        private readonly IHoldingPhoneLineRequestLogic requestLogic;
        private readonly IHoldingPhoneLineRequestLifeCycleLogic lifeCycleLogic;
        private readonly IEquipmentLogic equipmentLogic;

        public HoldingPhoneLineRequestController(IAccountLogic accountLogic, IEmployeeLogic employeeLogic, IAccountPermissionLogic accountPermissionLogic,
           ...
           IHoldingPhoneLineRequestLogic requestLogic, IHoldingPhoneLineRequestLifeCycleLogic lifeCycleLogic, IEquipmentLogic equipmentLogic)
        {
        ...
        private async Task PopulateDropDownList(HoldingPhoneLineRequestViewModel model)
        {
        ...
        private async Task<HoldingPhoneLineRequest> InitializeRequest(HoldingPhoneLineRequestViewModel model, Employee user)
        {
            HoldingPhoneLineRequest request = new HoldingPhoneLineRequest();
        ...
        private HoldingPhoneLineRequestLifeCycle InitializeLifeCycle(int requestId, Employee user, string message)
        {
            HoldingPhoneLineRequestLifeCycle lifeCycle = new HoldingPhoneLineRequestLifeCycle();
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            HoldingPhoneLineRequest request = await requestLogic.GetRequestById(id);
            List<HoldingPhoneLineRequestLifeCycle> lifeCycles = await lifeCycleLogic.GetLifeCycles(request);
            HoldingPhoneLineDetailsRequestViewModel model = ModelFromData.GetViewModel(request, user, lifeCycles);
            return View(model);
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Create(HoldingPhoneLineRequestViewModel model)
        {
            await PopulateDropDownList(model);
            Employee user = await PopulateAccountInfo();
        ...
        public async Task<ActionResult> Edit(int id)
        {
            await PopulateAccountInfo();
            var request = await requestLogic.GetRequestById(id);
            HoldingPhoneLineRequestViewModel model = ModelFromData.GetViewModel(request);
            await PopulateDropDownList(model);
            return View(model);
        }
        [HttpPost]
        public async Task<ActionResult> Edit(HoldingPhoneLineRequestViewModel model)
        {
            Employee user = await PopulateAccountInfo();
            await PopulateDropDownList(model);
        ...
        [HttpPost]
        public async Task<ActionResult> Delete(int id, HoldingPhoneLineRequestViewModel model)
        {
            Employee user = await PopulateAccountInfo();
            var request = await requestLogic.GetRequestById(id);
        ...
        public async Task<ActionResult> AddMessage(int id, HoldingPhoneLineDetailsRequestViewModel model)
        {
            Employee user = await PopulateAccountInfo();
            var service = await serviceLogic.GetServiceById(SERVICE_ID);
