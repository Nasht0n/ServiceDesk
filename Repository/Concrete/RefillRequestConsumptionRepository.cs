...
{
    public class RefillRequestConsumptionRepository : IRefillRequestConsumptionRepository
    {
        // Логгер
        ...
        public RefillRequestConsumptionRepository(ServiceDeskContext context)
        {
        ...
        public async Task<List<RefillRequestConsumption>> GetConsumptions()
        {
            ...
            try
            {
                ...
                var list = await context.RefillRequestConsumptions.ToListAsync();
                // остановка таймера
                watch.Stop();
