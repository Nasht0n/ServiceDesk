...
{
    public class RepairRequestJournalRepository : IRepairRequestJournalRepository
    {
        // Логгер
        ...
        public RepairRequestJournalRepository(ServiceDeskContext context)
        {
        ...
        public async Task<List<RepairRequestJournal>> GetJournals()
        {
            ...
            try
            {
                ...
                var list = await context.RepairRequestJournals.ToListAsync();
                // остановка таймера
                watch.Stop();
