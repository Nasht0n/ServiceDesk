...
{
    /// <summary>
    /// Класс доступа к хранилищу прикрепленных файлов заявки на регистрацию учетной записи
    /// </summary>
    public class AccountRegistrationRequestAttachmentsRepository : IAccountRegistrationRequestAttachmentsRepository
    {
        ...
        {
            log.Debug($"Метод добавления файла к заявке на регистрацию учетной записи");
            try
            {
        ...
        {
            log.Debug($"Метод удаления файла заявки на регистрацию учетной записи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
        ...
        {
            log.Debug($"Метод получения списка прикрепленных файлов заявки на регистрацию учетной записи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
