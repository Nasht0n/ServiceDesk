...
{
    /// <summary>
    /// Класс доступа к заявке об утере учетной записи
    /// </summary>
    public class AccountLossRequestRepository : IAccountLossRequestRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи заявки об утере учетной записи");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей заявки об утере учетной записи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей заявки об утере учетной записи: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи заявки об утере учетной записи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
