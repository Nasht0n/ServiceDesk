...
{
    /// <summary>
    /// Класс доступа к хранилищу жизненного цикла заявки на аннулирование учетной записи
    /// </summary>
    public class AccountCancellationRequestLifeCycleRepository : IAccountCancellationRequestLifeCycleRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи жизненного цикла заявки на аннулирование учетной записи");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей жизненного цикла заявки на аннулирование учетной записи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей жизненного цикла заявки на аннулирование учетной записи: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
