...
namespace Repository.Concrete.Branches.IT.Communication.Requests
{
    ...
    public class HoldingPhoneLineRequestRepository : IHoldingPhoneLineRequestRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи заявки на прокладку телефонной линии");
            try
            {
        ...
        {
            log.Debug($"Метод удаления записи жизненного цикла заявки на прокладку телефонной линии");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
        ...
        {
            log.Debug($"Метод получения списка записей заявки на прокладку телефонной линии");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей заявки на прокладку телефонной линии: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи заявки на прокладку телефонной линии");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
