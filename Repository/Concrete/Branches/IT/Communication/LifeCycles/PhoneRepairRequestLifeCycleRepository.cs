...
namespace Repository.Concrete.Branches.IT.Communication.LifeCycles
{
    ...
    public class PhoneRepairRequestLifeCycleRepository : IPhoneRepairRequestLifeCycleRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи жизненного цикла заявки на ремонт телефонного аппарата");
            try
            {
        ...
        {
            log.Debug($"Метод удаления записи жизненного цикла заявки на ремонт телефонного аппарата");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
        ...
        {
            log.Debug($"Метод получения списка записей жизненного цикла заявки на ремонт телефонного аппарата");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей жизненного цикла заявки на ремонт телефонного аппарата: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи жизненного цикла заявки на ремонт телефонного аппарата");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
