...
{
    /// <summary>
    /// Класс доступа к хранилищу жизненного цикла заявки на выделение телефонного номера
    /// </summary>
    public class PhoneNumberAllocationRequestLifeCycleRepository : IPhoneNumberAllocationRequestLifeCycleRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи жизненного цикла заявки на выделение телефонного номера");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей жизненного цикла заявки на выделение телефонного номера");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей жизненного цикла заявки на выделение телефонного номера: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи жизненного цикла заявки на выделение телефонного номера");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
