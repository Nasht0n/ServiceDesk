...
{
    /// <summary>
    /// Класс доступа к хранилищу заявок на замену комплектующего оборудования
    /// </summary>
    public class ComponentReplaceRequestRepository : IComponentReplaceRequestRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи заявки на замену комплектующего оборудования");
            try
            {
        ...
        {
            log.Debug($"Метод удаления записи жизненного цикла заявки на замену комплектующего оборудования");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
        ...
        {
            log.Debug($"Метод получения списка записей заявки на замену комплектующего оборудования");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей заявки на замену комплектующего оборудования: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи заявки на замену комплектующего оборудования");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
