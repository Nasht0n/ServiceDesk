...
{
    /// <summary>
    /// Класс доступа к хранилищу заявок на ремонт оборудования
    /// </summary>
    public class EquipmentRepairRequestRepository : IEquipmentRepairRequestRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи заявки на ремонт оборудования");
            try
            {
        ...
        {
            log.Debug($"Метод удаления записи жизненного цикла заявки на ремонт оборудования");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
        ...
        {
            log.Debug($"Метод получения списка записей заявки на ремонт оборудования");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей заявки на ремонт оборудования: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи заявки на ремонт оборудования");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
