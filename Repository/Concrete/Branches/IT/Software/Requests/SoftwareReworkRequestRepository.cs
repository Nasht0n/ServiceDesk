...
{
    /// <summary>
    /// Класс доступа к хранилищу заявок на доработку программного обеспечения
    /// </summary>
    public class SoftwareReworkRequestRepository : ISoftwareReworkRequestRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи заявки на доработку программного обеспечения");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей заявки на доработку программного обеспечения");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей заявки на доработку программного обеспечения: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи заявки на доработку программного обеспечения");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
