...
{
    /// <summary>
    /// Класс доступа к хранилищу жизненного цикла заявки на регистрацию электронной почты
    /// </summary>
    public class EmailRegistrationRequestLifeCycleRepository : IEmailRegistrationRequestLifeCycleRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи жизненного цикла заявки на регистрацию электронной почты");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей жизненного цикла заявки на регистрацию электронной почты");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
        ...
        {
            log.Debug($"Метод редактировния записи жизненного цикла заявки на регистрацию электронной почты");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
