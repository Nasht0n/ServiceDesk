...
{
    /// <summary>
    /// Класс доступа к хранилищу заявок на проведение видеосвязи
    /// </summary>
    public class VideoCommunicationRequestRepository : IVideoCommunicationRequestRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи заявки на проведение видеосвязи");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей заявки на проведение видеосвязи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей заявки на проведение видеосвязи: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи заявки на проведение видеосвязи");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
