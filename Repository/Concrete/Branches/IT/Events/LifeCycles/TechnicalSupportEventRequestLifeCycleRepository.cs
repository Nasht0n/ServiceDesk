...
{
    /// <summary>
    /// Класс доступа к хранилищу жизненного цикла заявки на техническое сопровождение мероприятия
    /// </summary>
    public class TechnicalSupportEventRequestLifeCycleRepository : ITechnicalSupportEventRequestLifeCycleRepository
    {
        ...
        {
            log.Debug($"Метод добавления записи жизненного цикла заявки на техническое сопровождение мероприятия");
            try
            {
        ...
        {
            log.Debug($"Метод получения списка записей жизненного цикла заявки на техническое сопровождение мероприятия");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
            ...
            {
                log.Error($"Ошибка получения списка записей жизненного цикла заявки на техническое сопровождение мероприятия: {ex.Message}.");
                return null;
            }
        }
        /// <summary>
        ...
        {
            log.Debug($"Метод редактировния записи жизненного цикла заявки на техническое сопровождение мероприятия");
            try
            {
                log.Debug($"Начало выполнения метода.");
                // старт таймера
