...
namespace Domain.Models.Requests.Email
{
    ...
    public class EmailRegistrationRequestLifeCycle:LifeCycle
    {
        ...
        /// </summary>
        public EmailRegistrationRequestLifeCycle() { }
        /// <summary>
        ...
        public EmailRegistrationRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        {
            return $"EmailRegistrationRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is EmailRegistrationRequestLifeCycle && obj != null)
            {
                EmailRegistrationRequestLifeCycle temp = (EmailRegistrationRequestLifeCycle)obj;
