...
namespace Domain.Models.Requests.Email
{
    ...
    public class EmailSizeIncreaseRequest:Request
    {
        ...
        public EmailSizeIncreaseRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId, int clientId, int executorGroupId, string email)
        {
            Title = title;
