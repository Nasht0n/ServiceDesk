...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на подключение оборудования к ЛВС"
    /// </summary>
    public class NetworkConnectionRequest : Request
    {
        ...
        /// </summary>
        public NetworkConnectionRequest() { }
        /// <summary>
        ...
        public NetworkConnectionRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId,
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на подключение оборудования к ЛВС.</returns>
        public override string ToString()
        {
            return $"NetworkConnectionRequest object:(Id:[{Id}];Title:[{Title}];Justification:[{Justification}];Description:[{Description}];ServiceId:[{ServiceId}];" +
        ...
        {
            if (obj is NetworkConnectionRequest && obj != null)
            {
                NetworkConnectionRequest temp = (NetworkConnectionRequest)obj;
