...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Жизненный цикл заявки на подключение оборудования к сети ЛВС"
    /// </summary>
    public class NetworkConnectionRequestLifeCycle:LifeCycle
    {
        /// <summary>
        /// Идентификатор заявки на подключение оборудования к сети ЛВС
        /// </summary>
        [Required]
        public int RequestId { get; set; }
        /// <summary>
        /// Объект заявки на подключение оборудования к сети ЛВС
        /// </summary>
        public NetworkConnectionRequest Request { get; set; }
        /// <summary>
        /// Конструктор по умолчанию
        /// </summary>
        public NetworkConnectionRequestLifeCycle() { }
        /// <summary>
        ...
        public NetworkConnectionRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта жизненного цикла заявки на подключение оборудования к сети ЛВС.</returns>
        public override string ToString()
        {
            return $"NetworkConnectionRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is NetworkConnectionRequestLifeCycle && obj != null)
            {
                NetworkConnectionRequestLifeCycle temp = (NetworkConnectionRequestLifeCycle)obj;
