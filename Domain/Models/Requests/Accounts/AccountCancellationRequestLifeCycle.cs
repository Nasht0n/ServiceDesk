...
namespace Domain.Models.Requests.Accounts
{
    ...
    public class AccountCancellationRequestLifeCycle:LifeCycle
    {
        ...
        /// </summary>
        public AccountCancellationRequestLifeCycle() { }
        /// <summary>
        ...
        public AccountCancellationRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта жизненного цикла заявки на аннулирование учетной записи.</returns>
        public override string ToString()
        {
            return $"AccountCancellationRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if(obj is AccountCancellationRequestLifeCycle && obj != null)
            {
                AccountCancellationRequestLifeCycle temp = (AccountCancellationRequestLifeCycle)obj;
