...
namespace Domain.Models.Requests.Accounts
{
    ...
    public class AccountDisconnectRequestLifeCycle:LifeCycle
    {
        ...
        /// </summary>
        public AccountDisconnectRequestLifeCycle() { }
        /// <summary>
        ...
        public AccountDisconnectRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта жизненного цикла заявки на отключение учетной записи.</returns>
        public override string ToString()
        {
            return $"AccountDisconnectRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is AccountDisconnectRequestLifeCycle && obj != null)
            {
                AccountDisconnectRequestLifeCycle temp = (AccountDisconnectRequestLifeCycle)obj;
