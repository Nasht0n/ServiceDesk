...
namespace Domain.Models.Requests.Accounts
{
    ...
    public class AccountRegistrationRequest:Request
    {
        ...
        public AccountRegistrationRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId, int clientId, int executorGroupId)
        {
            Title = title;
