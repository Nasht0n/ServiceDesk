...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на регистрацию учетной записи"
    /// </summary>
    public class AccountRegistrationRequest:Request
    {
        ...
        /// </summary>
        public virtual IList<AccountRegistrationRequestAttachment> Attachments { get; set; }
        /// <summary>
        /// Конструктор по умолчанию
        /// </summary>
        public AccountRegistrationRequest() {
            Attachments = new List<AccountRegistrationRequestAttachment>();
        }
        /// <summary>
        ...
        public AccountRegistrationRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId,  int clientId, int executorGroupId)
        {
            Title = title;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на регистрацию учетной записи.</returns>
        public override string ToString()
        {
            return $"AccountRegistrationRequest object:(Id:[{Id}];Title:[{Title}];Justification:[{Justification}];Description:[{Description}];ServiceId:[{ServiceId}];" +
        ...
        {
            if (obj is AccountRegistrationRequest && obj != null)
            {
                AccountRegistrationRequest temp = (AccountRegistrationRequest)obj;
