...
namespace Domain.Models.Requests.Accounts
{
    ...
    public class AccountDisconnectRequest:Request
    {
        ...
        public AccountDisconnectRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int clientId, int executorGroupId)
        {
            Title = title;
