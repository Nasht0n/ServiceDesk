...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на доработку программного обеспечения"
    /// </summary>
    public class SoftwareReworkRequest:Request
    {
        ...
        /// </summary>
        public virtual IList<SoftwareReworkRequestAttachment> Attachments { get; set; }
        /// <summary>
        /// Конструктор по умолчанию
        /// </summary>
        public SoftwareReworkRequest()
        {
            Attachments = new List<SoftwareReworkRequestAttachment>();
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на доработку программного обеспечения.</returns>
        ...
        {
            if (obj is SoftwareReworkRequest && obj != null)
            {
