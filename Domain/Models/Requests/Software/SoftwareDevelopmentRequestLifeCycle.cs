...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Жизненный цикл заявки на разработку программного обеспечения"
    /// </summary>
    public class SoftwareDevelopmentRequestLifeCycle:LifeCycle
    {
        /// <summary>
        /// Идентификатор заявки на разработку программного обеспечения
        /// </summary>
        [Required]
        public int RequestId { get; set; }
        /// <summary>
        /// Объект заявки на разработку программного обеспечения
        /// </summary>
        public SoftwareDevelopmentRequest Request { get; set; }
        /// <summary>
        /// Конструктор по умолчанию
        /// </summary>
        public SoftwareDevelopmentRequestLifeCycle() { }
        /// <summary>
        ...
        public SoftwareDevelopmentRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        {
            return $"SoftwareDevelopmentRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is SoftwareDevelopmentRequestLifeCycle && obj != null)
            {
                SoftwareDevelopmentRequestLifeCycle temp = (SoftwareDevelopmentRequestLifeCycle)obj;
