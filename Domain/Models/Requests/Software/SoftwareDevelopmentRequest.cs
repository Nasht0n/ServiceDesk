...
namespace Domain.Models.Requests.Software
{
    ...
    public class SoftwareDevelopmentRequest:Request
    {
        ...
        public SoftwareDevelopmentRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId, int clientId, int executorGroupId)
        {
            Title = title;
