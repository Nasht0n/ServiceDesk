...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на замену комплектующего оборудования"
    /// </summary>
    public class ComponentReplaceRequest:Request
    {
        ...
        /// <summary>
        /// Список заменяемого комплектующего
        /// </summary>
        public IList<ReplaceComponents> ReplaceComponents { get; set; }
        /// <summary>
        /// Конструктор по умолчанию
        /// </summary>
        public ComponentReplaceRequest() { }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на замену комплектующего оборудования.</returns>
        ...
        {
            if (obj is ComponentReplaceRequest && obj != null)
            {
