...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на замену оборудования"
    /// </summary>
    public class EquipmentReplaceRequest:Request
    {
        ...
        public EquipmentReplaceRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId,
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на замену оборудования.</returns>
        public override string ToString()
        {
            return $"EquipmentReplaceRequest object:(Id:[{Id}];Title:[{Title}];Justification:[{Justification}];Description:[{Description}];ServiceId:[{ServiceId}];" +
        ...
        {
            if (obj is EquipmentReplaceRequest && obj != null)
            {
                EquipmentReplaceRequest temp = (EquipmentReplaceRequest)obj;
