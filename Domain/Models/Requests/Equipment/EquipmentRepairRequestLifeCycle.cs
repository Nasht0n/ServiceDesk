...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Жизненный цикл заявки на ремонт оборудования"
    /// </summary>
    public class EquipmentRepairRequestLifeCycle:LifeCycle
    {
        ...
        /// </summary>
        public EquipmentRepairRequestLifeCycle() { }
        /// <summary>
        ...
        public EquipmentRepairRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта жизненного цикла заявки на ремонт оборудования.</returns>
        public override string ToString()
        {
            return $"EquipmentRepairRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is EquipmentRepairRequestLifeCycle && obj != null)
            {
                EquipmentRepairRequestLifeCycle temp = (EquipmentRepairRequestLifeCycle)obj;
