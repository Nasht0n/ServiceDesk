...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Жизненный цикл заявки на установку оборудования"
    /// </summary>
    public class EquipmentInstallationRequestLifeCycle:LifeCycle
    {
        ...
        /// </summary>
        public EquipmentInstallationRequestLifeCycle() { }
        /// <summary>
        ...
        public EquipmentInstallationRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта жизненного цикла заявки на установку оборудования.</returns>
        public override string ToString()
        {
            return $"EquipmentInstallationRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is EquipmentInstallationRequestLifeCycle && obj != null)
            {
                EquipmentInstallationRequestLifeCycle temp = (EquipmentInstallationRequestLifeCycle)obj;
