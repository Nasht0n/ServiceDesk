...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на заправку оборудования"
    /// </summary>
    public class EquipmentRefillRequest:Request
    {
        ...
        public EquipmentRefillRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId,
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на заправку техники.</returns>
        public override string ToString()
        {
            return $"EquipmentRefillRequest object:(Id:[{Id}];Title:[{Title}];Justification:[{Justification}];Description:[{Description}];ServiceId:[{ServiceId}];" +
        ...
        {
            if (obj is EquipmentRefillRequest && obj != null)
            {
                EquipmentRefillRequest temp = (EquipmentRefillRequest)obj;
