...
namespace Domain.Models.Requests.Communication
{
    ...
    public class HoldingPhoneLineRequest:Request
    {
        ...
        /// </summary>
        public HoldingPhoneLineRequest() { }
        /// <summary>
        ...
        public HoldingPhoneLineRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId, 
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на проведение телефонной линии.</returns>
        ...
        {
            if (obj is HoldingPhoneLineRequest && obj != null)
            {
