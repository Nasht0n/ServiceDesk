...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Заявка на проведение телефонной линии"
    /// </summary>
    public class PhoneLineRepairRequest:Request
    {
        ...
        public PhoneLineRepairRequest(string title, string justification, string description, int serviceId, int statusId, int priorityId, int cabinetId,
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта заявки на ремонт телефонной линии.</returns>
        public override string ToString()
        {
            return $"PhoneLineRepairRequest object:(Id:[{Id}];Title:[{Title}];Justification:[{Justification}];Description:[{Description}];ServiceId:[{ServiceId}];" +
        ...
        {
            if (obj is PhoneLineRepairRequest && obj != null)
            {
                PhoneLineRepairRequest temp = (PhoneLineRepairRequest)obj;
