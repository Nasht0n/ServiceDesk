...
{
    /// <summary>
    /// Класс-сущность, содержащий описание данных для хранения в таблице "Жизненный цикл заявки на ремонт телефонной линии"
    /// </summary>
    public class PhoneLineRepairRequestLifeCycle:LifeCycle
    {
        /// <summary>
        /// Идентификатор заявки на ремонт телефонной линии
        /// </summary>
        [Required]
        public int RequestId { get; set; }
        /// <summary>
        /// Объект заявки на ремонт телефонной линии
        /// </summary>
        public PhoneLineRepairRequest Request { get; set; }
        /// <summary>
        /// Конструктор по умолчанию
        /// </summary>
        public PhoneLineRepairRequestLifeCycle() { }
        /// <summary>
        ...
        public PhoneLineRepairRequestLifeCycle(DateTime date, string message, int requestId, int employeeId)
        {
            Date = date;
            RequestId = requestId;
            Message = message;
        ...
        /// </summary>
        /// <returns>Возвращает строковое представление объекта жизненного цикла заявки на ремонт телефонной линии.</returns>
        public override string ToString()
        {
            return $"PhoneLineRepairRequestLifeCycle object:(Id:[{Id}];Date:[{Date}];Message:[{Message}];RequestId:[{RequestId}];EmployeeId:[{EmployeeId}]).";
        }
        /// <summary>
        ...
        {
            if (obj is PhoneLineRepairRequestLifeCycle && obj != null)
            {
                PhoneLineRepairRequestLifeCycle temp = (PhoneLineRepairRequestLifeCycle)obj;
